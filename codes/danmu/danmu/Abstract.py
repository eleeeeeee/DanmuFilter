import abc, threading, time, logging, os
import pandas as pd
...
class AbstractDanMuClient(object):
    ...
    __workdir__ = r'C:/Users/Jeremy/Desktop/NLP/DanmuFilter/DanmuFilter/'
    ...
    def loadhistoryliveid(self,filename):
        his_tab = set()
        if not os.path.isfile(filename):
            return False,his_tab
        with open(filename) as f:
            for line in f:
                his_tab.add(line.strip().split(',')[0])
        return True,his_tab
    def start(self):
